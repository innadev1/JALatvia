<html>
	...
	<div class="capture_aktualitates">
		...
		<div id="top-bt">
			<a href="news.php"><button id="main-button-on-top">Lasīt vairāk</button></a>
		</div>
	</div>
	...
	<!--<div class="capture_aktualitates_2">
		...
		<div id="news">
			...
			<div class="wrap">
				...
				<h1><a href="news.php">SMU Light Up Eiropas finālā izpelnās Beļģijas karaļa uzmanību</a></h1>
				...
				<div>
				<h2>22.07</h2>
				<h1><a href="news.php">Pieteikšanās inovatīvu Skolēnu mācību uzņēmumu izveides un konsultēšanas vasaras apmācībām!</a></h1>
				...
				<div>
				<h2>06.08</h2>
				<h1><a href="news.php">Piesakies vidusskolēnu uzņēmējdarbības akseleratoram "JESS 2017"</a></h1>
