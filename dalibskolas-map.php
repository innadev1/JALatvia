<html>
	...
	<body>
		<!--<div id="buttons">
			<div><button><a href="dalibskolas.php">Dalībskolām</a></button></div>
			<div><button><a href="dalibskolas-map.php">Dalībskolas</button></div>
			<div><button><a href="dalibskolas-skolotaji.php">Skolotāju apmācības</a></button></div>
			<div><button><a href="dalibskolas-skolas.php">Skolu Krustvecāki</a></button></div>
			<div><button><a href="dalibskolas-klubs.php">Brīvprātīgo klubs</a></button></div>
		</div>-->
		...
		<div id="dalibskolas_content-2">
			...
			<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDshNemRPHjEhzG3Vc-I7Nl-FMFD3FkVTA&callback=initMap"
			async defer></script>
