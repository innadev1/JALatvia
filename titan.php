<html>
	...
	<div class="capture_titan">
		...
		skolēni pielieto visas iegūtās zināšanas un iemaņas, lai pierādītu, ka viņu firma ir labāka, spēj izkonku-<br>
	...
	<div class="piesakies"><button>piesakies</button></div>
		...
		<div id="main_info">
			<div id="content_1">
				...
				<div><p>
				<span>Spēles gaita!</span> Spēlē aicināti piedalīties JA Latvija dalībskolu skolēni, veidojot komandas 2-4 cilvēku sastāvā. Spēle ir sadalīta pa ceturkšņiem, un katrā no tiem skolēni veic informācijas analīzi un pieņem lēmumus par ražojamās produkcijas apjomu, produkta cenu, mārketinga aktivitātēm, attīstību un modernizāciju, kā arī investīcijām.
				</p></div>
				<div><p>
				<span>Kā uzvarēt?</span> Veiksmīgākais uzņēmums spēlē JA TITAN tiek noteikts pēc panākumu indeksa (Performance Index), ko veido pieci rādītāji: nesadalītā peļņa (50 %), pieprasījuma potenciāls (20 %), piedāvājuma potenciāls (10 %), tirgus daļa (10 %) un attīstība (10 %).
				</p></div>
				<div><p>
				<b>Biznesa simulācijas spēles JA TITAN Latvijas <span>čempionāta uzvarētājiem</span> TALLINK Latvija dāvina <span>kruīzu uz Stokholmu.</span>
				</b></p></div>
			</div>
